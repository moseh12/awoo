                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">NYS Panel | Login</h1>
                                    </div>
                                    ...
                                    <div class="form-label-group">
                                     ...
                                     <div class="form-label-group">
                                      ...
                                      <div class="form-label-group">
                                        ...
                                        <button name="login" class="btn btn-primary btn-user"> REGISTER</button>
                                        <p>Already have Account? <a href="register.php">LOGIN NOW</a> </p>
                                    </form>
                                </div>
                            </div>
                        </div>
